...
def main(argv=None):
    ...
    ap.add_argument("--restriccion", type=float, default=0.30, help="Entorno.restricción (dificulta →W)")
    ap.add_argument("--amortiguacion", type=float, default=0.40, help="Ruido.amortiguación (frena →P)")
    ...
    ap.add_argument("--temp-step", type=float, default=0.03, help="Incremento de temperatura por ciclo")
    ap.add_argument("--boost", type=float, default=0.25, help="Refuerzo de prob si el evento se cumple")
